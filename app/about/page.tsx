			...
			<Layout >
				...
				<section className="section-testimonial-13 position-relative pt-120 pb-80 fix ">
					<div className="container position-relative z-1">
						...
						<img className="position-absolute z-2 top-0 end-0 pe-10 pe-lg-10" src="/assets/imgs/cta-15/star-2.svg" alt="limpiar" />
						<img className="position-absolute z-2 bottom-0 start-0 ps-10 ms-10" src="/assets/imgs/cta-15/star-1.svg" alt="limpiar" />
					</div>
					<div className="container-fluid">
						<div className="d-flex align-items-center justify-content-center position-relative">
							<div className="pe-3 position-relative z-1 d-none d-md-block">
								<img className="rounded-3 border border-3 border-white" src="/assets/imgs/cta-15/img-1.png" alt="limpiar" />
							</div>
							<div className="pe-3 position-relative z-1">
								<img className="rounded-3 border border-3 border-white" src="/assets/imgs/cta-15/img-2.png" alt="limpiar" />
							</div>
							<div className="pe-3 position-relative z-1">
								<img className="rounded-3 border border-3 border-white" src="/assets/imgs/cta-15/img-3.png" alt="limpiar" />
							</div>
							<div className="pe-3 position-relative z-1">
								<img className="rounded-3 border border-3 border-white" src="/assets/imgs/cta-15/img-4.png" alt="limpiar" />
							</div>
							<div className="pe-3 position-relative z-1 d-none d-md-block">
								<img className="rounded-3 border border-3 border-white" src="/assets/imgs/cta-15/img-5.png" alt="limpiar" />
							</div>
							<img className="position-absolute top-50 end-50 translate-middle-y z-0" src="/assets/imgs/cta-15/bg-ellipse.png" alt="limpiar" />
						</div>
							...
							<div className="col-lg-6 ps-lg-8 mt-lg-0 mt-5">
								...
								<div className="d-flex flex-column flex-md-row">
									<div className="evaluate-1 me-2">
										...
										<p className="text-500 mt-3">limpiar's platform is intuitive and powerful. The custom solutions provided have streamlined our workflow.</p>
									</div>
					...
					<div className="container">
						<div className="row">
							...
							<div className="col-lg-6 offset-lg-1 mt-lg-0 mt-8">
								<p className="fs-5 text-900 mb-5"><span className="fw-bold">limpiar</span> was founded with a passion for technology and a desire to make a difference in the digital world. From our humble beginnings, we have grown into a reputable and sought-after web development agency, serving a diverse range of clients across various industries. Over the years, <span className="fw-bold">we have successfully delivered countless projects</span>, each one a testament to our dedication, expertise, and innovative approach. Our journey has been marked by <span className="fw-bold">continuous growth, learning, and adaptation,</span> and we are proud of the milestones we have achieved along the way.</p>
								<p className="fs-5 text-900 mb-5">Thank you for considering <span className="fw-bold">limpiar</span> as your web development partner. We look forward to helping you achieve your <span className="fw-bold">digital goals and creating a lasting impact</span> on your business.</p>
								<div className="d-flex">
									...
									<div className="ms-2">
										...
										<h6 className="mt-1 mb-0">Demi Oloyede <span className="text-500 fs-6">, CEO</span></h6>
									</div>
								</div>
							</div>
						</div>
