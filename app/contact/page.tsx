						...
						<div className="row">
							<div className="col-12 col-md-6 col-lg-4 mb-5 mb-md-0">
								<div className="feature-item mb-5 mb-lg-0 pe-5 hover-up">
									<div className="bg-primary-soft icon-flip position-relative icon-shape icon-xxl rounded-3 mb-4">
										<div className="icon">
											<img src="/assets/imgs/contact-5/icon-1.svg" alt="limpiar" />
										</div>
									</div>
									<h6>Help  support</h6>
							...
							<div className="col-12 col-md-6 col-lg-4 mb-5 mb-md-0">
								<div className="feature-item mb-5 mb-lg-0 pe-5 hover-up">
									<div className="bg-primary-soft icon-flip position-relative icon-shape icon-xxl rounded-3 mb-4">
										<div className="icon">
											<img src="/assets/imgs/contact-5/icon-2.svg" alt="limpiar" />
										</div>
									</div>
									<h6>Call Us</h6>
									<p className="text-500">
							...
							<div className="col-12 col-md-6 col-lg-4 mb-5 mb-md-0">
								<div className="feature-item mb-5 mb-lg-0 pe-5 hover-up">
									<div className="bg-primary-soft icon-flip position-relative icon-shape icon-xxl rounded-3 mb-4">
										<div className="icon">
											<img src="/assets/imgs/contact-5/icon-3.svg" alt="limpiar" />
										</div>
									</div>
							...
							{/* <div className="col-12 col-md-6 col-lg-3 mb-5 mb-md-0">
								<div className="feature-item mb-5 mb-lg-0 pe-5 hover-up">
									<div className="bg-primary-soft icon-flip position-relative icon-shape icon-xxl rounded-3 mb-4">
										<div className="icon">
											<img src="/assets/imgs/contact-5/icon-4.svg" alt="limpiar" />
										</div>
									</div>
									<h6>Global branch</h6>
									<p className="text-500">
							...
							<div className="col-lg-6">
								...
								<div className="d-flex pt-6 pb-3 align-items-center">
									<div className="bg-white-keep icon-flip position-relative icon-shape icon-xxl rounded-3">
										<div className="icon">
											<img src="/assets/imgs/contact-1/icon-1.svg" alt="limpiar" />
										</div>
									</div>
									<div className="ps-5">
								...
								<div className="d-flex pt-3 pb-3 align-items-center">
									<div className="bg-white-keep icon-flip position-relative icon-shape icon-xxl rounded-3">
										<div className="icon">
											<img src="/assets/imgs/contact-1/icon-2.svg" alt="limpiar" />
										</div>
									</div>
									<div className="ps-5">
								...
								<div className="d-flex pt-3 pb-3 align-items-center">
									<div className="bg-white-keep icon-flip position-relative icon-shape icon-xxl rounded-3">
										<div className="icon">
											<img src="/assets/imgs/contact-1/icon-3.svg" alt="limpiar" />
										</div>
									</div>
									<div className="ps-5">
										<h6 className="text-white">Visit the Knowledge Base</h6>
