				...
				<div className="container">
					<div className="pt-120 pb-120 bg-4 rounded-5 position-relative">
						<div className="row align-items-center text-center position-relative z-1">
							<div className="col-lg-6 mx-auto">
								<div className="px-lg-3 text-center">
									...
									<p className="fs-6 fw-medium text-900">By clicking the button, you are agreeing with our <Link href="/privacy-policy" className="text-decoration-underline link-hover-primary-light">Term  Conditions</Link></p>
						...
						<div className="position-absolute bottom-0 start-0 m-10 pb-5 ps-4">
							<img className=" " src="/assets/imgs/newsletter-3/icon-1.png" alt="limpiar" />
						</div>
						<div className="position-absolute top-0 end-0 m-10 pb-5 ps-4">
							<img className=" " src="/assets/imgs/newsletter-3/icon-2.png" alt="limpiar" />
						</div>
					</div>
				</div>
			</section>
