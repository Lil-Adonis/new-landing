						...
						<div className="col-lg-4">
							<div className="pe-6">
								...
								<div className="d-flex align-items-center mt-8">
									<Link href="#" className="fw-bold btn bg-white text-primary hover-up">See all case studies
									...
									<div className="swiper-wrapper">
										<SwiperSlide className="swiper-slide">
											<div className="card border-0 rounded-3 position-relative d-inline-flex card-hover">
												<img className="rounded-top-3" src="/assets/imgs/blog-1/card-img-1.png" alt="limpiar" />
